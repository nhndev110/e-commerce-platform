    ...
    <div class="container">
      <div class="header-left">
        ...
        <a href="{{ route('home.index') }}" class="logo">
          <img src="{{ asset('shop/images/demos/demo-4/logo.png') }}" alt="Molla Logo" width="105" height="25">
        </a>
      </div>
          ...
          <div class="dropdown-menu dropdown-menu-right">
            <div class="dropdown-cart-products">
              <div class="product">
                ...
                <figure class="product-image-container">
                  <a href="product.html" class="product-image">
                    <img src="{{ asset('shop/images/products/cart/product-1.jpg') }}" alt="product">
                  </a>
                </figure>
              ...
              <div class="product">
                ...
                <figure class="product-image-container">
                  <a href="product.html" class="product-image">
                    <img src="{{ asset('shop/images/products/cart/product-2.jpg') }}" alt="product">
                  </a>
                </figure>

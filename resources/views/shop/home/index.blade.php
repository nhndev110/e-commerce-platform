...
@section('Styles')
  <link rel="stylesheet" href="{{ asset('shop/css/pages/home.min.css') }}">
@endsection

@section('Scripts')
  <script src="{{ asset('shop/js/demos/demo-4.js') }}"></script>
@endsection
...
@section('main')
  <div class="intro-slider-container mb-5">
    <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl"
      ...
      <div class="intro-slide" style="background-image: url(shop/images/demos/demo-4/slider/slide-1.png);">
      ...
      <div class="intro-slide" style="background-image: url(shop/images/demos/demo-4/slider/slide-2.png);">
        <div class="container intro-content">
          <div class="row justify-content-end">
            <div class="col-auto col-sm-7 col-md-6 col-lg-5">
      ...
      <div class="row">
        <div class="col-6 col-sm-4 col-lg-2">
          <a href="category.html" class="cat-block">
            <figure>
              <span>
                <img src="shop/images/demos/demo-4/cats/1.png" alt="Category image">
              </span>
            </figure>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
          <a href="category.html" class="cat-block">
            <figure>
              <span>
                <img src="shop/images/demos/demo-4/cats/2.png" alt="Category image">
              </span>
            </figure>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
          <a href="category.html" class="cat-block">
            <figure>
              <span>
                <img src="shop/images/demos/demo-4/cats/3.png" alt="Category image">
              </span>
            </figure>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
          <a href="category.html" class="cat-block">
            <figure>
              <span>
                <img src="shop/images/demos/demo-4/cats/4.png" alt="Category image">
              </span>
            </figure>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
          <a href="category.html" class="cat-block">
            <figure>
              <span>
                <img src="shop/images/demos/demo-4/cats/5.png" alt="Category image">
              </span>
            </figure>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
          <a href="category.html" class="cat-block">
            <figure>
              <span>
                <img src="shop/images/demos/demo-4/cats/6.png" alt="Category image">
              </span>
            </figure>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 col-lg-4">
        <div class="banner banner-overlay banner-overlay-light">
          <a href="#">
            <img src="shop/images/demos/demo-4/banners/banner-1.png" alt="Banner">
          </a>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="banner banner-overlay banner-overlay-light">
          <a href="#">
            <img src="shop/images/demos/demo-4/banners/banner-2.jpg" alt="Banner">
          </a>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="banner banner-overlay banner-overlay-light">
          <a href="#">
            <img src="shop/images/demos/demo-4/banners/banner-3.png" alt="Banner">
          </a>
        ...
        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
          ...
          <div class="product product-2">
            <figure class="product-media">
              ...
              <a href="product.html">
                <img src="shop/images/demos/demo-4/products/product-1.jpg" alt="Product image" class="product-image">
              </a>
          ...
          <div class="product product-2">
            <figure class="product-media">
              <a href="product.html">
                <img src="shop/images/demos/demo-4/products/product-2.jpg" alt="Product image" class="product-image">
              </a>
          ...
          <div class="product product-2">
            <figure class="product-media">
              ...
              <a href="product.html">
                <img src="shop/images/demos/demo-4/products/product-3.jpg" alt="Product image" class="product-image">
              </a>
          ...
          <div class="product product-2">
            <figure class="product-media">
              ...
              <a href="product.html">
                <img src="shop/images/demos/demo-4/products/product-4.jpg" alt="Product image" class="product-image">
              </a>
          ...
          <div class="product product-2">
            <figure class="product-media">
              <span class="product-label label-circle label-top">Top</span>
              <a href="product.html">
                <img src="shop/images/demos/demo-4/products/product-5.jpg" alt="Product image" class="product-image">
              </a>
  ...
  <div class="container">
    <div class="cta cta-border mb-5" style="background-image: url(shop/images/demos/demo-4/bg-1.jpg);">
      <img src="shop/images/demos/demo-4/camera.png" alt="camera" class="cta-img">
      <div class="row justify-content-center">
        <div class="col-md-12">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 deal-col">
        <div class="deal" style="background-image: url('shop/images/demos/demo-4/deal/bg-1.jpg');">
          <div class="deal-top">
      ...
      <div class="col-lg-6 deal-col">
        <div class="deal" style="background-image: url('shop/images/demos/demo-4/deal/bg-2.jpg');">
          <div class="deal-top">
  ...
  <div class="container">
    ...
    <div class="owl-carousel mt-5 mb-5 owl-simple" data-toggle="owl"
      ...
      <a href="#" class="brand">
        <img src="shop/images/brands/1.png" alt="Brand Name">
      </a>

      <a href="#" class="brand">
        <img src="shop/images/brands/2.png" alt="Brand Name">
      </a>

      <a href="#" class="brand">
        <img src="shop/images/brands/3.png" alt="Brand Name">
      </a>

      <a href="#" class="brand">
        <img src="shop/images/brands/4.png" alt="Brand Name">
      </a>

      <a href="#" class="brand">
        <img src="shop/images/brands/5.png" alt="Brand Name">
      </a>

      <a href="#" class="brand">
        <img src="shop/images/brands/6.png" alt="Brand Name">
      </a>
    </div><!-- End .owl-carousel -->
  </div><!-- End .container -->
    ...
    <div class="container trending-products">
      ...
      <div class="row">
        <div class="col-xl-5col d-none d-xl-block">
          <div class="banner">
            <a href="#">
              <img src="shop/images/demos/demo-4/banners/banner-4.jpg" alt="banner">
            </a>
          </div><!-- End .banner -->
        </div><!-- End .col-xl-5col -->
              ...
              <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                ...
                <div class="product product-2">
                  <figure class="product-media">
                    <span class="product-label label-circle label-top">Top</span>
                    <a href="product.html">
                      <img src="shop/images/demos/demo-4/products/product-6.jpg" alt="Product image"
                        class="product-image">
                    </a>
                ...
                <div class="product product-2">
                  <figure class="product-media">
                    <a href="product.html">
                      <img src="shop/images/demos/demo-4/products/product-7.jpg" alt="Product image"
                        class="product-image">
                    </a>
                ...
                <div class="product product-2">
                  <figure class="product-media">
                    <span class="product-label label-circle label-new">New</span>
                    <a href="product.html">
                      <img src="shop/images/demos/demo-4/products/product-8.jpg" alt="Product image"
                        class="product-image">
                    </a>
                ...
                <div class="product product-2">
                  <figure class="product-media">
                    ...
                    <span class="product-label label-circle label-sale">Sale</span>
                    <a href="product.html">
                      <img src="shop/images/demos/demo-4/products/product-9.jpg" alt="Product image"
                        class="product-image">
                    </a>
                ...
                <div class="product product-2">
                  <figure class="product-media">
                    <span class="product-label label-circle label-new">New</span>
                    <a href="product.html">
                      <img src="shop/images/demos/demo-4/products/product-3.jpg" alt="Product image"
                        class="product-image">
                    </a>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product product-2">
            <figure class="product-media">
              <span class="product-label label-circle label-sale">Sale</span>
              <a href="product.html">
                <img src="shop/images/demos/demo-4/products/product-10.jpg" alt="Product image" class="product-image">
              </a>
  ...
  <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url(shop/images/demos/demo-4/bg-5.jpg);">
    <div class="container">
      <div class="row justify-content-center">

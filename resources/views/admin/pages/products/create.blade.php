        ...
        <div class="card-header">
          ...
          <div class="card-tools">
            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal">
              ...
              <span class="ml-2 font-weight-bold">Upload Image</span>
            </button>
            @include('admin.pages.products.upload-file')
            <button type="button" class="btn btn-tool" data-card-widget="collapse">
              <i class="fas fa-minus"></i>
            </button>
          </div>
                      ...
                      <div class="row ml-2">
                        ...
                        <div class="col-9">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="setThumbnail" id="setThumbnail">
